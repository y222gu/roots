...
def main():
    ...
    image_size_list = [128, 256, 512, 1024]

    # MODIFY THESE PATHS
    checkpoint_path_list = [
        r"C:\Users\Yifei\Documents\data_for_publication\results\optimize_image_size\image_size_128\models\Unet_resnet34\best_model_loss_0.1701_dice_0.8570_epoch_342.pth",
        r"C:\Users\Yifei\Documents\data_for_publication\results\optimize_image_size\image_size_256\models\Unet_resnet34\best_model_loss_0.1296_dice_0.8954_epoch_327.pth",
        r"C:\Users\Yifei\Documents\data_for_publication\results\optimize_image_size\image_size_512\models\Unet_resnet34\best_model_loss_0.1033_dice_0.9126_epoch_350.pth",
        r"C:\Users\Yifei\Documents\data_for_publication\results\optimize_image_size\image_size_1024\models\Unet_resnet34\best_model_loss_0.0869_dice_0.9299_epoch_335.pth"
    ]
    train_data_dir = r"C:\Users\yifei\Documents\data_for_publication\train_preprocessed_cropped"
    test_data_dir = r"C:\Users\yifei\Documents\data_for_publication\test_preprocessed_cropped"
    ...
    for ax, metric in zip(axes, metric_names):
        ax.set_title(f"{metric.capitalize()} vs Image Size")
