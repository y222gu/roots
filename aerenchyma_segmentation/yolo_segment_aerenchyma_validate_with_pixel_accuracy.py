...
if __name__ == '__main__':
    ...
    # Paths
    val_images_path = os.path.join(os.getcwd(), "aerenchyma_segmentation", "data_for_segmentation", "images", "val_normalized")
    labels_path = os.path.join(os.getcwd(), "aerenchyma_segmentation", "data_for_segmentation", "labels", "val_normalized")
